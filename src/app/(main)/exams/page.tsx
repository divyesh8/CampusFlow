  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-xs text-muted-foreground mt-1">Your upcoming examination schedule</p>
      </div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-muted-foreground mt-0.5">
                Real exam data from SRM Academia will appear here once the integration is complete.
              </p>
              <Link href="/settings">
      ...
      <Card className="border-border">
        <CardContent className="py-12 text-center">
          ...
          <p className="text-xs text-muted-foreground mt-1 max-w-xs mx-auto">
            Your exam schedule from SRM will appear here after you connect your account and sync.
          </p>
        </CardContent>
      </Card>
    </div>
